...
## Active Commitments
- Active commitment: Protect operator trust
- Active commitment: Ship precise answers

## Relationship Context
- Relationship: operator -&gt; trusted (primary owner)
- Relationship: repo -&gt; maintainer (owns release lane)
...
- Identity fingerprint: id-normal
...
- Input hash: inp_d8f7ab408104473e

## Explain
Explain Alpha Builder
## Status Summary
- Compose mode: compose mode resolved to normal from registry status Some(Active), recovery state Some(Healthy), and offline policy Cautious
...
## Warnings
- Compose mode: 0 warnings emitted after compose-mode-specific severity ordering and deduplication

## System Prompt Prefix
- Template: prompt prefix rendered from template `prompt-prefix`
- Compose mode: render uses normal mode and profile `Alpha Builder`
...
- Provenance: input hash inp_d8f7ab408104473e locks the normalized compose inputs
